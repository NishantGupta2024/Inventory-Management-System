...
class BillClass:
    def __init__(self, root):
        ...
        txt_search=Entry(ProductFrame2,textvariable=self.var_search,font=("Times New Roman",15),bg="lightyellow").place(x=128,y=47,height=22)
        btn_search=Button(ProductFrame2,text="Search",command=self.search,font=("goudyold style",15),bg="#2196f3",fg="white",cursor="hand2").place(x=285,y=45,width=100,height=25)
       ...
       #=====CALCULATOR FRAME=======
        ...
        btn_sum=Button(Cal_Frame,text='-',font=('arial',15,'bold'),command=lambda:self.get_input('-'),bd=5,width=4,pady=10,cursor="hand2").grid(row=2,column=3)
       ...
       #=====CART FRAME=======
        ...
        self.cartTitle=Label(Cart_Frame,text="Cart Total Details: [0]",font=("goudy old style",15),bg="lightgray")
        self.cartTitle.pack(side=TOP,fill=X)

        scrolly=Scrollbar(Cart_Frame,orient=VERTICAL)
        scrollx=Scrollbar(Cart_Frame,orient=HORIZONTAL)

        self.CartTable=ttk.Treeview(Cart_Frame,columns=("pid","name","price","quantity","stock"),yscrollcommand=scrolly.set,xscrollcommand=scrollx.set)
        ...
        self.CartTable.column("stock",width=80)
     ...
     #=======================billing button==========================
        ...
        self.lbl_amnt.place(x=5,y=5,width=140,height=70)

        self.lbl_discount=Label(billMenuFrame,text='Discount\n[5%]',font=("goudy old style",15,"bold"),bg="blue",fg='White')
        self.lbl_discount.place(x=146,y=5,width=120,height=70)

        self.lbl_net_pay=Label(billMenuFrame,text='Net Pay\n[0]',font=("goudy old style",15,"bold"),bg="orange",fg='White')
        self.lbl_net_pay.place(x=267,y=5,width=125,height=70)

        btn_print=Button(billMenuFrame,text='Print',cursor='hand2',font=("goudy old style",15,"bold"),bg="green",fg='White')
        ...
        btn_clear_all.place(x=124,y=80,width=108,height=50)
        ...
        btn_generate.place(x=232,y=80,width=162,height=50)

    #================================footer============================
        footer=Label(self.root,text="IMS-Inventory Management System | \n For any Technical Issue contact: 987xxxxx04",font=("times new roman",11),bg='#4d636d',fg='white').pack(side=BOTTOM,fill=X)
        self.show()
    ...
    def Generate_bill(self):
        if self.var_cname.get()=='' or self.var_contact.get()=='':
            ...
            messagebox.showerror("Error","First please add the product in cart list. ",parent=self.root)        
        else:
            ##-----Bill Top--------
            self.Bill_Top()
            ##-----Bill Middle--------
            ...
            fp.close()
            messagebox.showinfo('Saved',"Bill has generated and saved successfully !!",parent=self.root)
    ...
    def Bill_Top(self):
        ...
        bill_top_temp=f'''
\t\tXYZ - Inventory
\tPhone no. - 98527xxxxx , Delhi-125001
{str("="*47)}
Consumer name - {self.var_cname.get()}
...
Net Amount to Pay\t\t\t\t      Rs.{self.net_pay}
{str("="*47)}        
        ''' 
